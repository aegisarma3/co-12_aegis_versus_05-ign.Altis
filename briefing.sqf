...
[
	{true}, 
		...
		["Situation",
			"December 8th 2024: by browsing old news articles, PMC Versus local high command (callsign 'Corona') has learned that the number one business man on Altis, Mr. Simonides Dionysodoros has invested not only in ouzo but also in olive oil business. He currently owns the only <marker name='obj1'>olive plantation</marker> on Altis but the whole patch of trees were lost to a forest fire this autumn. Mr. Dionysodoros has ordered a large quantity of olive tree saplings which are currently waiting at the plantation for spring to be planted.<br/><br/>Corona has inserted two Versus teams in the vicinity of the plantation: the <marker name='perditus_start'>surgical team</marker> (callsign 'Perditus') and the <marker name='derelictus_start'>supporting team</marker> (callsign 'Derelictus'). The mission has two objectives: Versus operators are to destabilize the Altian economy by eliminating Mr. Dionysodoros and making sure the production does not continue by destroying the saplings. The teams will use the cover of darkness and fog to infiltrate the area, complete the objectives and leave to AO to the <marker name='obj3'>north</marker>.<br/><br/>Since Versus operators have not yet been able to recover their buried weapons from the south tip of Altis, the teams will have something less than ideal at their disposal."],

		["Enemy",
			"Corona estimates that the plantation and the manor are heavily guarded by Mr. Dionysodoros' personal guard detail. Although their equipment is not believed to be military grade, they have a reputation of fighting effectively off Nekron Chelia in the past. As PMC Versus learned last month, Mr. Dionysodoros' investments on Altis are recognized and protected by the AAF. Corona has located the nearest AAF quick reaction force about 700 meters south-east and the Versus operators should be expecting enemy reinforcements from that direction.<br/><br/>Corona advices the teams to observe the enemy before engaging and leaving the AO before the AAF forces can respond - Versus forces will be at significant disadvantage againt organized military forces.<br/><br/>Corona advices Versus operators again to make use of flashlights, flares and chemlights since Versus has not been able to acquire NVGs. The plantation guards and workers also lack NV capabilities and sneaking in should be relatively easy. Corona has chosen this moonless night in particular for the operation."],
